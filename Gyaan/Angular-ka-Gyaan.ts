...
/**
 ...
 or ---> ng g c recipes --spec false //skips test file creation
...
/**
 😒Pipes:
 CLI command: ng generate pipe pipename
...
/**
 ...
 Note: this returns an observable (which is unsubscribe by angular on its own)
